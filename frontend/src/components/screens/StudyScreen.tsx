...
export const StudyScreen: React.FC<StudyScreenProps> = ({
  ...
  const englishExplanation = currentCard.descriptionEn || currentCard.description;
  const shouldShowEnglishExplanation = englishExplanation.trim() !== primaryExplanation.trim();
            ...
            >
              ...
              >
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center px-2 min-h-0">
                  <div className="max-h-full overflow-y-auto hide-scrollbar">
                    <h2 className="text-[30px] font-black text-slate-900 tracking-tight leading-[1.12] mb-6 break-words select-none">
              ...
              >
                <div className="flex items-center gap-3 mb-6 bg-slate-50 p-3 rounded-2xl border border-slate-100/50">
                  ...
                  <h3 className="text-[18px] font-black text-slate-900 leading-snug break-words min-w-0">
                    {currentCard.conceptZh}
                  </h3>
                </div>

                <div className="flex-1 overflow-y-auto hide-scrollbar pr-1">
                  <p className="text-[15px] text-slate-700 leading-[1.7] font-semibold bg-white rounded-2xl whitespace-pre-wrap">
                    {primaryExplanation}
                  </p>
                  {shouldShowEnglishExplanation && (
                    <div className="mt-5 rounded-2xl border border-slate-100 bg-slate-50/70 p-4">
                      <div className="mb-2 text-[10px] font-black uppercase tracking-[0.18em] text-blue-500">
                        English Original
                      </div>
                      <p className="text-[13px] text-slate-500 leading-[1.65] font-medium whitespace-pre-wrap">
                        {englishExplanation}
                      </p>
                    </div>
                  )}
